...
BEGIN
	SET PRECIO_FINAL = TOTAL_RESERVA(FECHA_ING, PRECIO);
    INSERT INTO RSERVACION(ID_HABITACION, ID_CLIENTE, PRECIO, FECHA_ING, FECHA_SAL, FEHCA_RES) 
...
-- TRIGGER
DELIMITER $$
CREATE TRIGGER T_ESTADO_HABITACION
